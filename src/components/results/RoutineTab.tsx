  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="font-display text-headline-md font-semibold text-on-surface">Daily Schedule</h3>
      ...
      <div className="bg-surface-container rounded-xl p-5">
        <h3 className="font-display text-headline-md font-semibold text-on-surface mb-3">Weekly Practices</h3>
