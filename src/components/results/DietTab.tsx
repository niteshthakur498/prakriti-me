  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-primary-fixed/30 border border-primary-fixed rounded-xl p-5">
        <h3 className="font-display text-headline-md font-semibold text-on-surface mb-3">Key Principles</h3>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-secondary-container/20 border border-secondary/20 rounded-xl p-4">
          <p className="text-label-md font-semibold text-secondary mb-2">Favor Tastes</p>
        ...
        <div className="bg-error-container/20 border border-error/20 rounded-xl p-4">
          <p className="text-label-md font-semibold text-error mb-2">Reduce Tastes</p>
          <div className="flex flex-wrap gap-2">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-secondary-container/10 border border-secondary/20 rounded-xl p-5 sun-shadow">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-display text-headline-md font-semibold text-secondary">Favor These Foods</h3>
          </div>
        ...
        <div className="bg-error-container/10 border border-error/20 rounded-xl p-5 sun-shadow">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-display text-headline-md font-semibold text-error">Minimize These</h3>
          </div>
          <ul className="space-y-3">
