      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-10 grid md:grid-cols-2 gap-12 items-center">
        <div className="z-10">
          ...
          <h1 className="font-display text-5xl md:text-6xl font-bold text-on-surface mb-6 leading-tight tracking-tight">
            Discover Your<br />True Nature
          </h1>
          <p className="text-body-lg text-on-surface-variant mb-10 max-w-lg">
            Unlock thousands of years of Vedic wisdom with a 5-minute quiz tailored to your unique bio-energy profile.
          </p>
          ...
          <div className="mt-12 flex flex-wrap gap-6 items-center">
            <div className="flex items-center gap-2 text-on-surface-variant text-label-md font-semibold">
              <span className="text-secondary">✓</span> Based on classical texts
            </div>
            <div className="flex items-center gap-2 text-on-surface-variant text-label-md font-semibold">
              <span className="text-secondary">✓</span> Trusted by practitioners
            </div>
            <div className="flex items-center gap-2 text-on-surface-variant text-label-md font-semibold">
              <span className="text-secondary">✓</span> 5 min · Free
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="aspect-square rounded-[3rem] overflow-hidden sun-shadow relative bg-surface-container flex items-center justify-center">
            <div className="text-center p-8">
              ...
              <p className="text-on-surface-variant text-body-md mt-2">Your innate nature</p>
            </div>
